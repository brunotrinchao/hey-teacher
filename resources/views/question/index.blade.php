                        ...
                        <x-table.td>
                            <div class="flex justify-start space-x-3">
                                <x-form :action="route('question.destroy', $question)" delete>
                                    <button type="submit"
                                            class="text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-2 py-1 text-center me-2 mb-2 dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">
                                        Delete
                                    </button>
                                </x-form>
                        ...
                        <x-table.td>
                            <div class="flex justify-start space-x-3">
                                ...
                                <x-form :action="route('question.archive', $question)" patch>
                                    <button type="submit"
                                            class="text-stone-700 hover:text-white border border-stone-700 hover:bg-stone-800 focus:ring-4 focus:outline-none focus:ring-stone-300 font-medium rounded-lg text-sm px-2 py-1 text-center me-2 mb-2 dark:border-stone-500 dark:text-stone-500 dark:hover:text-white dark:hover:bg-stone-600 dark:focus:ring-stone-900">
                                        Archive
                                    </button>
                                </x-form>
                            </div>
